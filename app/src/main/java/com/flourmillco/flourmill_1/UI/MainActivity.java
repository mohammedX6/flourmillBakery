...
import com.flourmillco.flourmill_1.Services.LocationService;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BasketDB basketDB = new BasketDB(getApplicationContext());
        basketDB.deleteall();
    ...
    private boolean isLocationServiceIsRunning() {
        ...
        for (ActivityManager.RunningServiceInfo serviceInfo : manager.getRunningServices(Integer.MAX_VALUE)) {
            if ("com.flourmillco.flourmill_1.Services.LocationService".equals(serviceInfo.service.getClassName())) {
