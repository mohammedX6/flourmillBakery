package com.flourmillco.flourmill_1.Services;
...
public class LocationService extends Service {
    ...
    private final static long UPDATE_INTERVAL = 3000;
      ...
      /*  if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_DENIED) {
        ...
        fusedLocationProviderClient.requestLocationUpdates(locationRequestHighAccuracy, new LocationCallback() {
                    ...
                    public void onLocationResult(LocationResult locationResult) {
                        ...
                        if (location != null) {
                            User user = ((UserSingle) (getApplicationContext())).getUser();
    ...
    private void saveUserLocation(final UserLocation location) {
        try {
            DocumentReference locationRef = FirebaseFirestore.getInstance().collection("Bakerys_Location").document(FirebaseAuth.getInstance().getUid());
